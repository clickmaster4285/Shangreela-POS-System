                ...
                >
                  {item.image ? (
                    ...
                    <div className="flex flex-col flex-1 p-4 aspect-[4/3]">
                      <div className="flex-1">
                          <h3 className="text-sm font-bold text-foreground line-clamp-2 leading-snug">{item.name}</h3>
                          <div className="mt-1.5"><span className="inline-block px-2 py-0.5 rounded-md bg-muted text-[10px] uppercase font-bold tracking-widest text-muted-foreground border border-border/60">
                             {item.category}
                          </span></div>
                      ...
                      <div className="mt-3 flex items-center justify-between">
                          <span className="font-serif text-lg font-bold text-primary">Rs. {item.price.toLocaleString()}</span>
